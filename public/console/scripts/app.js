...
(function() {
  ...
  // Fix the relpath to not have index.html
  var pathname = location.pathname;
  var relpath = pathname.replace("index.html", "");

  var uri = location.protocol + '//' + location.host + relpath + 'authentication/oauth2.html';
