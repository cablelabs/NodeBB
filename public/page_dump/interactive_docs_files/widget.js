...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://forge.marvel.com";
...
if (typeof janrain.settings.width === 'undefined')janrain.settings.width = "354";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "gofcnefdmbcgfcjpgide";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://forge.marvel.com";
janrain.settings.permissions = ["customizable_auth_widget_hide_attribution","customizable_auth_widget_styling"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["facebook","google","twitter","yahoo"];
if (typeof janrain.settings.noReturnExperience === 'undefined')janrain.settings.noReturnExperience = false;
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "193166954153103";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://forge.marvel.com";
...
if (typeof janrain.settings.share.providersEmail === 'undefined')janrain.settings.share.providersEmail = ["yahoo","google"];
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('2014.WID.1.101.0_widgets_417');
    return path;
}
